function [tt,K,N,L,P,A,T,E,FDN,beam,S]=xtffe2mat_nomex(fname)
%
% [tt,K,N,L,P,A,T,E,FDN,beam,S]=xtffe2mat_nomex(fname);
%
% Outputs:
%
%   tt   = run title
...
% read in the header ... check that XTFF file is an ENVELOPE file
line=fgetl(fid);
xtff=line(9:16);
if (~strcmp(xtff,'ENVELOPE'))
...
for row=1:6
  line=fgetl(fid);
  for col=1:6
    e(row,col)=str2double(line(16*col-15:16*col));
  end
end
