function [tt,K,N,L,P,A,T,E,FDN,beam,S]=xtffe2mat(fname)
%
% [tt,K,N,L,P,A,T,E,FDN,beam,S]=xtffe2mat(fname);
%
% Outputs:
%
%   tt   = run title
...
if (exist('xtffe2mat_mex')==3)
  try
    % use the mex-file to download the data
    [tt,keyw,name,L,P,A,etyp,E,fnam,beam,S]=xtffe2mat_mex(fname);
