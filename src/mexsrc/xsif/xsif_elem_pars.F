...
C     MOD:
C          25-FEB-2004, PT:
C             moved EALIGN_DICT from EALIGN.f to this file.
C          17-DEC-2003, PT:
...
C     parameters related to EALIGN statements

      INTEGER*4, PARAMETER :: ED_SIZE = 8
      CHARACTER*8 EALIGN_DICT(ED_SIZE)
	DATA EALIGN_DICT /'DX      ','DY      ','DS      ',
     &                  'DPHI    ','DTHETA  ','DPSI    ',
     &                  'MREX    ','MREY    '/
